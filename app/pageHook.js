...
function PageHook() {
  ...
  return (
    ...
    <div className="h-full w-full p-3 flex flex-col items-center justify-center relative z-50">
      <Snowfall
        snowflakeCount={200}
        color="grey"
        style={{
      ...
      />
        ...
        <h1 className="text-3xl text-center font-bold  sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent dark:bg-gradient-to-r bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-800 capitalize md:max-w-2xl lg:max-w-3xl mx-auto ">
              Looking for <span className="text-[#E53333]">Love?</span> 
            </h1>
            <p className="max-w-[600px]  leading-7 text-center text-[16px] bg-clip-text text-transparent dark:bg-gradient-to-br bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-700 mx-auto ">
              Build Long Lasting Bond With Varcity Chat.
            </p>
            <p className="max-w-[600px]  leading-7 text-center text-[16px] bg-clip-text text-transparent dark:bg-gradient-to-br bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-700 mx-auto ">
             A platform for Universtiy Students across the Globe.
            </p>
              {/* boost your portoflio */}
         <section className=" w-full md:p-20 flex flex-col md:flex-row justify-between items-center">
        <div className="w-[80%] m-auto md:w-[45%] h-full mt-3 flex flex-col justify-center">
                    <h2 className="mt-8 md:mt-0 text-center md:text-start text-4xl font-bold">Boost your portfolio with free money</h2>
                    <p className="text-center md:text-start mt-4 text-xl">Discover all the information you need at a glance - status, capital required, and probability of an airdrop. Plus, you'll find full accompanying reports and step-by-step video tutorials.</p>
                    <button className="mt-4 w-60 p-2 px-3 text-white rounded-md"></button>
                   </div>
                   <div className="w-[70%] m-auto md:m-0 md:w-[50%] rounded-md h-[330px] justify-center items-center flex" style={{ backgroundImage: 'url(/img/walkingphone.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="w-[80%] m-auto md:m-0 md:w-[45%] h-full mt-3 flex flex-col justify-center">
                    <h2 className="text-center md:text-start text-4xl font-bold">Find the right opportunities</h2>
                    <p className="text-center md:text-start mt-4 text-xl">Don't waste time farming random airdrops that yield little or no rewards. We've helped our members earn 4 to 5 figure airdrops on projects like Optimism, Arbitrum, Wormhole, Jito, Jupiter and more.</p>
                    <button className="mt-4 w-60 p-2 px-3 text-white rounded-md"></button>
                   </div>
                   <div className="w-[80%] m-auto md:w-[50%] rounded-md h-[330px]  justify-center items-center flex" style={{ backgroundImage: 'url(/img/uniboys.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                   </div>
        </section> 
        ...
        <div className="space-y-4 ">
          <div className="space-y-2 text-center">
            ...
            <h1 className="text-3xl font-bold  sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent dark:bg-gradient-to-r bg-gradient-to-tr dark:from-white from-black to-neutral-600 dark:to-neutral-800 capitalize md:max-w-2xl lg:max-w-3xl mx-auto ">
              Join The Waitlist for <span className="text-[#E53333]">Varcity    
